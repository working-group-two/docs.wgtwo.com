    ...
    <div class="demo-config">
      <b-tabs :value="activeRoleTab" @input="setActiveRoleTab">
        ...
        >
          <p>
            Enter your
            <g-link to="/introduction/how-to/authorization/">access_token</g-link>, and it will be injected into the code examples below.
          </p>
        ...
        <b-tab-item label="Subscriber" :visible="availableRoles.has('SUBSCRIBER')" :key="2">
          ...
          <p>
            Enter your
            <g-link to="/introduction/how-to/authorization/">user token</g-link>, and it will be injected into the code examples below.
          </p>
...
export default {
  computed: {
    ...
    ...mapState({
      ...
      availableRoles: state => state.auth.availableRoles,
      activeRoleTab: state => state.auth.activeRoleTab,
